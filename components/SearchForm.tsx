...
export default function SearchForm() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    // Don't allow empty searches unless slider has been modified
    if (!query.trim() && !hasModifiedSlider) return
    ...
    // Add advanced search parameters if slider was modified and we're not using text search
    if (hasModifiedSlider && !query.trim()) {
